...
import { useUpdateCityMutation } from "../../../Redux/api/city/cityApi";

const EditCity = ({ editCityModal, handleCancel, currentRecord }) => {
  ...
  useEffect(() => {
    if (currentRecord) {
      form.setFieldsValue({
        cityName: currentRecord.cityName,
        postalCode:
          currentRecord.postalCode && currentRecord.postalCode.length > 0
      ...
      >
        <div className="mt-8">
          ...
          >
            ...
            <RButton type="submit" loadingMessage="Edit City" />
          </Form>
        </div>
      </Modal>
    </ConfigProvider>
