...
import { useUpdatePromotionMutation } from "../../../Redux/api/promotion/promotionApi";

const EditPromotion = ({ isModalOpen, handleCancel, currentRecord }) => {
  const [edit] = useUpdatePromotionMutation();
  ...
  useEffect(() => {
    form.setFieldsValue({
      ...
      couponCode: currentRecord?.couponCode,
      discount: currentRecord?.discount,
    });
  }, [
    currentRecord?.couponCode,
