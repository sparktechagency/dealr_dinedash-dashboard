      ...
      <div className="relative">
        {Array.from({ length: 10 }).map((_, index) => {
          return (
            ...
            //             <span className="font-semibold">Benefit:</span> 2 for 1
            //           </div>
            //           <div className="flex flex-col">
              ...
              <div className="flex flex-col md:flex-row items-start justify-between gap-4">
                <div>
                  ...
                  <div className="mt-3 bg-[#DBDBDB] p-3 rounded-md text-gray-700">
                    ...
                    <p className="w-[560px]">
                      Customer feedback suggests the discount should be
                      increased to 15% to be more competitive with nearby
                      restaurants.
                    </p>
                  </div>
                  ...
                  <p className="text-xs text-gray-500 mt-2">
                    <span className="font-semibold">Submitted:</span> 2024-01-15
                    10:30 AM
                  </p>
                </div>
